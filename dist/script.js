...
/*#__PURE__*/
function () {
  function Differens(oldOfficer, newOfficer, items) {
...
function () {
  function Form(forms) {
    ...
    this.message = {
      loading: 'Загрузка...',
      succes: 'Спасибо! Мы скоро с Вами свяжемься',
      ...
      this.forms.forEach(function (item) {
        item.addEventListener('submit', function (e) {
          ...
          _this.postData(_this.path, formData).then(function (res) {
            console.log(res);
            statusMessage.textContent = _this.message.succes;
          }).catch(function () {
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function bindTriggers() {
      ...
      this.btns.forEach(function (btn, i) {
        try {
          var blockedBtn = btn.closest('.module__video-item').nextElementSibling;
